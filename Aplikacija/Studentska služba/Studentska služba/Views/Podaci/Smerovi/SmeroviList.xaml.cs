...
using Studentska_služba.ViewModels.Podaci.Smerovi;
using System;
...
{
    public sealed partial class SmeroviList : UserControl
    {
        public SmeroviList()
        {
        ...
        public SmeroviViewModel vm
        {
            get { return (SmeroviViewModel)GetValue(vmProperty); }
