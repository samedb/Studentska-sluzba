#pragma checksum "C:\Users\Samed\Documents\GitHub\Studentska-sluzba\Aplikacija\Studentska služba\Studentska služba\Views\Podaci\Ocene\OceneView.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "F3040641495DBE5792FDB8EC6D7736B6"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Studentska_služba.Views.Podaci
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IOceneView_Bindings
        {
            ...
            private global::Studentska_služba.Views.Podaci.Ocene.OceneList obj9;
            ...
            public void Disable(int lineNumber, int columnNumber)
            {
                ...
                else if (lineNumber == 43 && columnNumber == 30)
                {
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 3: // Views\Podaci\Ocene\OceneView.xaml line 33
                        this.obj3 = (global::Studentska_služba.Views.Podaci.CommandLine)target;
                        this.bindingsTracking.RegisterTwoWayListener_3(this.obj3);
                        break;
                    case 4: // Views\Podaci\Ocene\OceneView.xaml line 46
                        this.obj4 = (global::Windows.UI.Xaml.Controls.StackPanel)target;
                        break;
                    case 5: // Views\Podaci\Ocene\OceneView.xaml line 52
                        this.obj5 = (global::Studentska_služba.Views.Podaci.Ocene.OcenaDetails)target;
                        this.bindingsTracking.RegisterTwoWayListener_5(this.obj5);
                        break;
                    case 6: // Views\Podaci\Ocene\OceneView.xaml line 55
                        this.obj6 = (global::Windows.UI.Xaml.Controls.StackPanel)target;
                        break;
                    case 7: // Views\Podaci\Ocene\OceneView.xaml line 59
                        this.obj7 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 8: // Views\Podaci\Ocene\OceneView.xaml line 63
                        this.obj8 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 9: // Views\Podaci\Ocene\OceneView.xaml line 43
                        this.obj9 = (global::Studentska_služba.Views.Podaci.Ocene.OceneList)target;
            ...
            private void Update_vm(global::Studentska_služba.ViewModels.Podaci.Ocene.OceneViewModel obj, int phase)
            {
                ...
                {
                    // Views\Podaci\Ocene\OceneView.xaml line 43
                    if (!isobj9vmDisabled)
                    {
                        XamlBindingSetters.Set_Studentska_služba_Views_Podaci_Ocene_OceneList_vm(this.obj9, obj, null);
                    }
                }
            }
            private void Update_vm_AddNewItemCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                ...
                {
                    // Views\Podaci\Ocene\OceneView.xaml line 33
            ...
            private void Update_vm_SelectedItem(global::StudentskaSluzba.Models.Ocena obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Ocene\OceneView.xaml line 46
                    ...
                    // Views\Podaci\Ocene\OceneView.xaml line 52
            ...
            private void Update_vm_DetailsMode(global::Studentska_služba.DetailsMode obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    // Views\Podaci\Ocene\OceneView.xaml line 55
            ...
            private void Update_vm_SaveChangesCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Ocene\OceneView.xaml line 59
            ...
            private void Update_vm_CancelCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Ocene\OceneView.xaml line 63
            ...
            private class OceneView_obj1_BindingsTracking
            {
                ...
                public void RegisterTwoWayListener_9(global::Studentska_služba.Views.Podaci.Ocene.OceneList sourceObject)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // Views\Podaci\Ocene\OceneView.xaml line 23
                {
