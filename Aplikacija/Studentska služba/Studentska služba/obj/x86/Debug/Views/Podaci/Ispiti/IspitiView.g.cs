#pragma checksum "C:\Users\Samed\Documents\GitHub\Studentska-sluzba\Aplikacija\Studentska služba\Studentska služba\Views\Podaci\Ispiti\IspitiView.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C577F7BF6D724021EF2D46188B62A073"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Studentska_služba.Views.Podaci
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IIspitiView_Bindings
        {
            ...
            private global::Studentska_služba.Views.Podaci.Ispiti.IspitiList obj3;
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 3: // Views\Podaci\Ispiti\IspitiView.xaml line 45
                        this.obj3 = (global::Studentska_služba.Views.Podaci.Ispiti.IspitiList)target;
                        this.bindingsTracking.RegisterTwoWayListener_3(this.obj3);
                        break;
                    case 4: // Views\Podaci\Ispiti\IspitiView.xaml line 48
                        this.obj4 = (global::Windows.UI.Xaml.Controls.StackPanel)target;
                        break;
                    case 5: // Views\Podaci\Ispiti\IspitiView.xaml line 53
                        this.obj5 = (global::Studentska_služba.Views.Podaci.Ispiti.IspitDetails)target;
                        this.bindingsTracking.RegisterTwoWayListener_5(this.obj5);
                        break;
                    case 6: // Views\Podaci\Ispiti\IspitiView.xaml line 56
                        this.obj6 = (global::Windows.UI.Xaml.Controls.StackPanel)target;
                        break;
                    case 7: // Views\Podaci\Ispiti\IspitiView.xaml line 60
                        this.obj7 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 8: // Views\Podaci\Ispiti\IspitiView.xaml line 64
                        this.obj8 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 9: // Views\Podaci\Ispiti\IspitiView.xaml line 28
            ...
            private void Update_vm(global::Studentska_služba.ViewModels.Podaci.Ispiti.IspitiViewModel obj, int phase)
            {
                ...
                {
                    // Views\Podaci\Ispiti\IspitiView.xaml line 45
                    if (!isobj3vmDisabled)
                    {
                        XamlBindingSetters.Set_Studentska_služba_Views_Podaci_Ispiti_IspitiList_vm(this.obj3, obj, null);
                    }
                }
            }
            private void Update_vm_SelectedItem(global::StudentskaSluzba.Models.Ispit obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Ispiti\IspitiView.xaml line 48
                    ...
                    // Views\Podaci\Ispiti\IspitiView.xaml line 53
            ...
            private void Update_vm_DetailsMode(global::Studentska_služba.DetailsMode obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    // Views\Podaci\Ispiti\IspitiView.xaml line 56
            ...
            private void Update_vm_SaveChangesCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Ispiti\IspitiView.xaml line 60
            ...
            private void Update_vm_CancelCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Ispiti\IspitiView.xaml line 64
            ...
            private void Update_vm_AddNewItemCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                ...
                {
                    // Views\Podaci\Ispiti\IspitiView.xaml line 28
            ...
            private class IspitiView_obj1_BindingsTracking
            {
                ...
                public void RegisterTwoWayListener_3(global::Studentska_služba.Views.Podaci.Ispiti.IspitiList sourceObject)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // Views\Podaci\Ispiti\IspitiView.xaml line 21
                {
