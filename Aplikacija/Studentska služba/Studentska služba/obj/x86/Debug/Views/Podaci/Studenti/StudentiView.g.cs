#pragma checksum "C:\Users\Samed\Documents\GitHub\Studentska-sluzba\Aplikacija\Studentska služba\Studentska služba\Views\Podaci\Studenti\StudentiView.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "5549F44FD66A910C4B3E663BC53A698A"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace Studentska_služba
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IStudentiView_Bindings
        {
            ...
            private global::Studentska_služba.StudentList obj3;
            ...
            public void Connect(int connectionId, global::System.Object target)
            {
                switch(connectionId)
                {
                    case 3: // Views\Podaci\Studenti\StudentiView.xaml line 45
                        this.obj3 = (global::Studentska_služba.StudentList)target;
                        this.bindingsTracking.RegisterTwoWayListener_3(this.obj3);
                        break;
                    case 4: // Views\Podaci\Studenti\StudentiView.xaml line 48
                        this.obj4 = (global::Windows.UI.Xaml.Controls.StackPanel)target;
                        break;
                    case 5: // Views\Podaci\Studenti\StudentiView.xaml line 53
                        this.obj5 = (global::Studentska_služba.StudentDetails)target;
                        this.bindingsTracking.RegisterTwoWayListener_5(this.obj5);
                        break;
                    case 6: // Views\Podaci\Studenti\StudentiView.xaml line 56
                        this.obj6 = (global::Windows.UI.Xaml.Controls.StackPanel)target;
                        break;
                    case 7: // Views\Podaci\Studenti\StudentiView.xaml line 60
                        this.obj7 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 8: // Views\Podaci\Studenti\StudentiView.xaml line 64
                        this.obj8 = (global::Windows.UI.Xaml.Controls.Button)target;
                        break;
                    case 9: // Views\Podaci\Studenti\StudentiView.xaml line 28
            ...
            private void Update_vm(global::Studentska_služba.StudentiViewModel obj, int phase)
            {
                ...
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (!isobj3vmDisabled)
                    {
                        XamlBindingSetters.Set_Studentska_služba_StudentList_vm(this.obj3, obj, null);
                    }
                }
            }
            private void Update_vm_SelectedItem(global::StudentskaSluzba.Models.Student obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Studenti\StudentiView.xaml line 48
                    ...
                    // Views\Podaci\Studenti\StudentiView.xaml line 53
            ...
            private void Update_vm_DetailsMode(global::Studentska_služba.DetailsMode obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    // Views\Podaci\Studenti\StudentiView.xaml line 56
            ...
            private void Update_vm_SaveChangesCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Studenti\StudentiView.xaml line 60
            ...
            private void Update_vm_CancelCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    // Views\Podaci\Studenti\StudentiView.xaml line 64
            ...
            private void Update_vm_AddNewItemCommand(global::GalaSoft.MvvmLight.Command.RelayCommand obj, int phase)
            {
                ...
                {
                    // Views\Podaci\Studenti\StudentiView.xaml line 28
            ...
            private class StudentiView_obj1_BindingsTracking
            {
                ...
                public void RegisterTwoWayListener_3(global::Studentska_služba.StudentList sourceObject)
                {
        ...
        public void Connect(int connectionId, object target)
        {
            switch(connectionId)
            {
            case 2: // Views\Podaci\Studenti\StudentiView.xaml line 21
                {
